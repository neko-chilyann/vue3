...
export interface IBizKeepAliveProps {
...
const IBizKeepAliveImpl: ComponentOptions = {
  name: `IBizKeepAlive`,
  ...
  setup(props: IBizKeepAliveProps, { slots }: SetupContext) {
...
if (__COMPAT__) {
  IBizKeepAliveImpl.__isBuildIn = true
}

// export the public type for h/tsx inference
// also to avoid inline import() in generated d.ts files
export const IBizKeepAlive = IBizKeepAliveImpl as any as {
  __isKeepAlive: true
  new (): {
    $props: VNodeProps & IBizKeepAliveProps
    $slots: {
      default(): VNode[]
    }
  }
